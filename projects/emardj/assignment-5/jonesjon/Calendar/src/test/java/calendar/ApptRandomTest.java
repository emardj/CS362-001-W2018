...
public class ApptRandomTest {
    ...
    public static String RandomSelectMethod(Random random){
        String[] methodArray = new String[] {"setTitle","setRecurrence","setStartDay","setStartHour","setStartMinute","setStartMonth"};// The list of the of methods to be tested in the Appt class
			...
			for (int i = 0; i < NUM_TESTS; i++) {
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					 ...
					 if (methodName.equals("setStartMinute")){
						 ...
						 int newMinute=(int) ValuesGenerator.getRandomIntBetween(random, -1, 65);
						 appt.setStartMinute(newMinute);
					}
					if (methodName.equals("setStartDay")){
						// System.out.println("DAY...");
						int newDay=(int) ValuesGenerator.getRandomIntBetween(random, 0, 35);
